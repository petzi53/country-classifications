...
1.  Locate the file for the UN M49 geoscheme classification data, get it
    and save it as raw data (@sec-download-m49).
...
As we can see from @cnj-clean-m49-1 the M49 classification of the United
...
seen in @cnj-show-intermediate-regional-groups --- there is a second
...
:::::: my-r-code
:::: my-r-code-header
::: {#cnj-add-un-member-state-column}
